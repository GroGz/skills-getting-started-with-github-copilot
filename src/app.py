...
activities = {
    ...
    "Basketball Team": {
        "description": "Train for competitive basketball games and team drills",
    ...
    "Drama Club": {
        "description": "Rehearse performances and stage creative theater productions",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["sarah@mergington.edu", "matt@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Study science concepts and compete in academic science events",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["nora@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Club": {
        "description": "Work on problem solving and prepare for math competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
